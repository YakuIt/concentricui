...
from concentricui.colourscheme.colourwidget import ColourProperties, ColourWidget
...
class ColourScreen(Screen, ColourWidget):
    ...
    def __init__(self, **kwargs):
        ...
        self.top_bar = TopBar(shape_size_hint_list=[1], colour_scheme=self.colour_scheme, master_colour='trim_colour', top=self.top, size_hint_y=None)
